...
@section('content_header')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">{{__('Karyawan')}}</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">{{__('Home')}}</a></li>
                        <li class="breadcrumb-item active">{{__('Karyawan')}}</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div>
                    ...
                    <div class="card">
                        <div class="card-header with-border">
                            <div class="d-flex justify-content-between w-100" style="margin-bottom: 10px;">
                                <div class="d-flex">
                                    <a href="{{ url('karyawan/create') }}" class="btn btn-primary float-right"><i class="fas fa-fw fa-plus"></i> {{__('Add Karyawan')}}</a>
                                </div>
                            </div>
                        </div>
                        <!-- /.card-header -->
